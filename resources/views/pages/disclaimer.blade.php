...
<ol>
  <li>Introduction <br>This website is operated by [Merchant Name]. The terms “we”, “us”, and “our” refer to
[Merchant Name]. The use of our website is subject to the following terms and conditions of
use, as amended from time to time (the “Terms”). The Terms are to be read together by you
...
mailing address and other contact details in order to complete your order or contact you as
needed. You agree to promptly update your account and information. You authorize us to collect
and use this information to contact you in accordance with our Privacy Policy.</li>

<li>General Conditions <br>
...
We do not guarantee the accuracy of the colour or design of the products on our website. We
have made efforts to ensure the colour and design of our products are displayed as accurately
as possible on our website.</li>

<li> Links to Third-Party Websites <br>
...
terms of the license agreement, if any, which accompanies or is provided with the software.</li>

<li>Use Comments, Feedback, and Other Submissions <br>
...
waive any claim against us for the removal and/or deletion of your Content.</li>
...
on incorrect pricing or availability information, to the extent permitted by applicable law.
We do not undertake to update, modify or clarify information on our website, except as required
by law.</li>

<li>Disclaimer and Limitation of Liability <br>
...
may not apply to you and our liability will be limited to the maximum extent permitted by law. </li>
...
written between you and us prior to such Terms, except as expressly stated in the Terms.</li>
...
subsequent default. No waiver by us is effective unless it is communicated to you in writing.</li>

<li>Headings <br>
Any headings and titles herein are for convenience only.</li>
...
Terms, which will continue to be valid and enforceable to the fullest extent permitted by law.</li>
...
the Province of [Name of Province] without regard to its conflict of law rules. Any disputes,
actions or proceedings relating to the Terms or your access to or use of our website must be
brought before the courts of the Province of [Name of Province] in the City of [Name of City],
[Name of Province]and you irrevocably consent to the exclusive jurisdiction and venue of such
courts.</li>

<li>Questions or Concerns <br>
Please send all questions, comments and feedback to us at [Email Address].</li>
...
identifiable information ("Personal Information"). As part of this commitment, our privacy policy
governs our actions as they relate to the collection, use and disclosure of Personal Information.
Our privacy policy is based upon the values set by the Canadian Standards Association's Model
Code for the Protection of Personal Information and Canada's Personal Information Protection
...
interested in. The purposes for which we collect Personal Information will be identified before or
at the time we collect the information. In certain circumstances, the purposes for which
information is collected may be clear, and consent may be implied, such as where your name,
address and payment information is provided as part of the order process.</li>
...
product or service, except as required to be able to supply the product or service.</li>

<li>Limiting Collection <br>
...
over the telephone or by corresponding with you via mail, facsimile, or the Internet.</li>

<li>Limiting Use, Disclosure and Retention <br>
...
Information will only be retained for the period of time required to fulfill the purpose for which we
collected it or as may be required by law. [If applicable, include a description of any parties
with whom you may share Personal Information.]</li>

<li>Accuracy <br>
Personal Information will be maintained in as accurate, complete and up-to-date form as is
necessary to fulfill the purposes for which it is to be used.</li>

<li>Safeguarding Customer Information <br>
...
Information from any loss or unauthorized use, access or disclosure.</li>

<li>Openness <br>
We will make information available to you about our policies and practices with respect to the
management of your Personal Information.</li>

<li>Customer Access <br>
...
example, we may not disclose information relating to you if other individuals are referenced or if
there are legal, security or commercial proprietary restrictions.</li>

<li>Handling Customer Complaints and Suggestions <br>
...
the privacy practices employed by third party websites. Therefore, we suggest that you examine
the privacy statements of those sites to learn how your information may be collected, used,
